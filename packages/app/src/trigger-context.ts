...
export const triggerContextCatalog: Record<string, ContextPath[]> = {
  ...
  clickup: [...commonWebhook,
    { path: "task", type: "object", description: "Complete ClickUp task fetched for the authenticated delivery." },
    { path: "task.id", type: "string", description: "ClickUp task ID." },
    { path: "task.name", type: "string", description: "Task title." },
    { path: "task.description", type: "string", description: "Task description." },
    { path: "task.url", type: "string", description: "Canonical ClickUp task URL." },
    { path: "task.status.status", type: "string", description: "Current status name." },
  ],
  github: [...commonWebhook,
    { path: "action", type: "string", description: "GitHub webhook action." },
    { path: "issue", type: "object", description: "Complete GitHub issue payload." },
    { path: "issue.number", type: "number", description: "Issue number.", example: 42 },
    { path: "issue.title", type: "string", description: "Issue title." },
    { path: "issue.body", type: "string", description: "Issue body, when present." },
    { path: "issue.html_url", type: "string", description: "Issue URL." },
    { path: "issue.state", type: "string", description: "Current issue state." },
