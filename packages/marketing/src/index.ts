...
<section><p class="eyebrow">How it works</p><h2>Automate each step</h2><p>Design jobs for agents, where a trigger kicks off an agent run with custom context.</p><ol><li><b>Create trigger</b><span>Webhooks, schedule, other jobs.</span></li><li><b>Write context</b><span>Combine context from your triggers to build the prompt.</span></li><li><b>Run the agent</b><span>Run the agent on your infrastructure of choice: VM, Cloud, even local.</span></li></ol></section></main><footer>Open-source software factories for everybody. · <a href="https://github.com/GenerationSoftware/factorize">View on GitHub</a></footer></body></html>`;
